...
export const countNeighbors = (y: number, x: number, boardState: boolean[][]): number => {
    const deltas = [-1, 0, 1]
...
export const checkWon = (historyState: boolean[][], boardState: boolean[][], setWon: Dispatch<SetStateAction<boolean>>, setHistoryState: Dispatch<SetStateAction<boolean[][]>> ): boolean => {
...
export const checkLost = (boardState: boolean[][], setLost: Dispatch<SetStateAction<boolean>>): boolean => {
